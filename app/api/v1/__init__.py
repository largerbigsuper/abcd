...
from .fileinfo import fileinfo_router
...
v1_router.include_router(fileinfo_router, prefix="/files", dependencies=[DependPermisson])
# v1_router.include_router(tags_router, prefix="/tags", dependencies=[DependPermisson])
